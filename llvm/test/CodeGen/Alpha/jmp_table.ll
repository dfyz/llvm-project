...
entry:
        ...
        %tmp.upgrd.1 = load i32, i32* %x_addr                ; <i32> [#uses=1]
...
bb:             ; preds = %entry
        %tmp.upgrd.2 = getelementptr [2 x i8], [2 x i8]* @str, i32 0, i64 0               ; <i8*> [#uses=1]
        store i8* %tmp.upgrd.2, i8** %foo
        br label %bb16

bb1:            ; preds = %entry
        %tmp2 = getelementptr [2 x i8], [2 x i8]* @str1, i32 0, i64 0             ; <i8*> [#uses=1]
        store i8* %tmp2, i8** %foo
        br label %bb16

bb3:            ; preds = %entry
        %tmp4 = getelementptr [2 x i8], [2 x i8]* @str2, i32 0, i64 0             ; <i8*> [#uses=1]
        store i8* %tmp4, i8** %foo
        br label %bb16

bb5:            ; preds = %entry
        %tmp6 = getelementptr [2 x i8], [2 x i8]* @str3, i32 0, i64 0             ; <i8*> [#uses=1]
        store i8* %tmp6, i8** %foo
        br label %bb16

bb7:            ; preds = %entry
        %tmp8 = getelementptr [2 x i8], [2 x i8]* @str4, i32 0, i64 0             ; <i8*> [#uses=1]
        store i8* %tmp8, i8** %foo
        br label %bb16

bb9:            ; preds = %entry
        %tmp10 = getelementptr [2 x i8], [2 x i8]* @str5, i32 0, i64 0            ; <i8*> [#uses=1]
        store i8* %tmp10, i8** %foo
        br label %bb16

bb11:           ; preds = %entry
        %tmp12 = getelementptr [2 x i8], [2 x i8]* @str6, i32 0, i64 0            ; <i8*> [#uses=1]
        store i8* %tmp12, i8** %foo
        br label %bb16

bb13:           ; preds = %entry
        %tmp14 = getelementptr [2 x i8], [2 x i8]* @str7, i32 0, i64 0            ; <i8*> [#uses=1]
...
bb16:           ; preds = %bb15, %bb13, %bb11, %bb9, %bb7, %bb5, %bb3, %bb1, %bb
        %tmp17 = load i8*, i8** %foo         ; <i8*> [#uses=1]
        %tmp18 = call i32 (...) @print( i8* %tmp17 )           ; <i32> [#uses=0]
        store i32 0, i32* %tmp
        %tmp19 = load i32, i32* %tmp         ; <i32> [#uses=1]
        store i32 %tmp19, i32* %retval
        br label %return

return:         ; preds = %bb16
        %retval.upgrd.3 = load i32, i32* %retval             ; <i32> [#uses=1]

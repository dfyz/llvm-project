...
static StringRef GetMachineInstrClassName(const Record *AsmWriter) {
  return AsmWriter->getValueAsBit("isMCAsmWriter") ? "MCInst" : "MachineInstr";
}
...
void AsmWriterEmitter::EmitGetMnemonic(
  ...
  O << "/// getMnemonic - This method is automatically generated by "
    ...
    << "::getMnemonic(const " << GetMachineInstrClassName(AsmWriter) << " *MI) {\n";
...
void AsmWriterEmitter::EmitPrintInstruction(
  ...
  O << "/// printInstruction - This method is automatically generated by "
       ...
       "void "
    << Target.getName() << ClassName
    << "::printInstruction(const " << GetMachineInstrClassName(AsmWriter) << " *MI, "
    << "uint64_t Address, " << (PassSubtarget ? "const MCSubtargetInfo &STI, " : "")
    << "raw_ostream &O) {\n";
